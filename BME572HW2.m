...
%% Method 
% The batch perceptron algorithm is used for a decision boundary. The
% threshold value of the classification (\theta) is set as 5.The learning
% coefficient is 0.1, and the initial weight is [0.1,-0.1,0.1]. Two
% datasets have the Gaussian distribution with an offset of 5.  Fig. 2
% shows that the number of misclassified data points decrease exponentially
% with iteration number. As shown by Fig.1, the decision boundary
% succesfully separates two linearly-separable dataset with 100% accuracy
% whtin ~20-50 trials
